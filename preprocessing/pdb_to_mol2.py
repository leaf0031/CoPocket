...
def convert_pdb_to_mol2(pdb_path: str, mol2_path: str) -> bool:
    ...
    try:
        ...
        # obabel /home/disk2/xxr/now/HGNN-GPT-last-new-2__2/case1/7kzh.pdb -O /home/disk2/xxr/now/HGNN-GPT-last-new-2__2/case1/7kzh.mol2
...
def get_unique_filename(filepath: str) -> str:
    """Ensure that existing files are not overwritten, and automatically add serial numbers."""
...
def process_files(
    ...
    """
    Process PDB files and convert them to MOL2 format.
    
    Args:
        source_dir: Input directory (containing PDB files)
        target_pockets: List of pockets to process (None indicates processing all)
...
def load_yaml_targets(yaml_path: str) -> List[str]:
    """Load the list of pockets to be processed from the YAML file."""
